...
#           Sun C 5.5 Patch 112760-06 2004/01/13
            CC='cc'
            CFLAGS='-g -KPIC -dalign -xlibmieee -D__EXTENSIONS__ -D_POSIX_C_SOURCE=199506L -mt -I$AMG_HOME/include'
            CLIBS="$MLIBS -lm -lc"
            COPTIMFLAGS='-xlibmil' # -DNDEBUG'
            CDEBUGFLAGS='-xs -g'
#           
#           CC -V
...
#           Sun Fortran 95 7.1 Patch 112762-09 2004/01/26
            FC='f90'
            FFLAGS='-g -KPIC -dalign -mt -I$AMG_HOME/include'
...
#
            LD="$COMPILER"
            LDEXTENSION='.mexsol'
            LDFLAGS="-g -G -mt -M$TMW_ROOT/extern/lib/$Arch/$MAPFILE"
            LDOPTIMFLAGS=''
            LDDEBUGFLAGS='-xs -g'
#
            POSTLINK_CMDS=':'
